...
export interface StreamOptions {
	...
	/**
	 * Opaque process-local credential generation used to isolate provider transport caches.
	 * Callers must not persist, log, or send this value as request metadata.
	 */
