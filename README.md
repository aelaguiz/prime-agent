...
- **Subagents are built in:** `rlm(...)` admits real child agents for parallel or background work and returns a child handle immediately; results arrive later through explicit agent messages or files.
